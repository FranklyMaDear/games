...
# Daily Missions (10-day plan)
DAILY_MISSIONS = [
    {
        "id": "d1", "day": 1,
        "description": "Play 1 match of Chess",
        "target": 1, "game": "Chess",
        "reward_type": "points", "reward_value": 20, "reward_label": "+20 Points",
        "link": "https://t.me/Franklygames_bot/chess"
    },
    {
        "id": "d2", "day": 2,
        "description": "Solve 1 Sudoku Puzzle",
        "target": 1, "game": "Sudoku",
        "reward_type": "stars", "reward_value": 10, "reward_label": "+10 Stars",
        "link": "https://t.me/Franklygames_bot/sudoku"
    },
    {
        "id": "d3", "day": 3,
        "description": "Play 1 match of Connect 4",
        "target": 1, "game": "Connect 4",
        "reward_type": "free_spin", "reward_value": 2, "reward_label": "+2 Free Spins",
        "link": "https://t.me/Franklygames_bot/connectfour"
    },
    {
        "id": "d4", "day": 4,
        "description": "Check your Daily Omen",
        "target": 1, "game": "Omen",
        "reward_type": "stars", "reward_value": 15, "reward_label": "+15 Stars",
        "link": "https://t.me/omenread_bot/omen"
    },
    {
        "id": "d5", "day": 5,
        "description": "Play 1 match of Balloons",
        "target": 1, "game": "Balloons",
        "reward_type": "points", "reward_value": 30, "reward_label": "+30 Points",
        "link": "https://t.me/Franklygames_bot/balloons"
    },
    {
        "id": "d6", "day": 6,
        "description": "Play Codewords once",
        "target": 1, "game": "Codewords",
        "reward_type": "free_spin", "reward_value": 3, "reward_label": "+3 Free Spins",
        "link": "https://t.me/crackthecodes_bot/codewords"
    },
    {
        "id": "d7", "day": 7,
        "description": "Visit LifeLine (Palmistry)",
        "target": 1, "game": "LifeLine",
        "reward_type": "stars", "reward_value": 20, "reward_label": "+20 Stars",
        "link": "https://t.me/lifeline2026_bot/games"
    },
    {
        "id": "d8", "day": 8,
        "description": "Play 2 matches of Connect 4",
        "target": 2, "game": "Connect 4",
        "reward_type": "points", "reward_value": 50, "reward_label": "+50 Points",
        "link": "https://t.me/Franklygames_bot/connectfour"
    },
    {
        "id": "d9", "day": 9,
        "description": "Win 2 matches of Chess",
        "target": 2, "game": "Chess",
        "reward_type": "free_spin", "reward_value": 5, "reward_label": "+5 Free Spins",
        "link": "https://t.me/Franklygames_bot/chess"
    },
    {
        "id": "d10", "day": 10,
        "description": "Complete 1 Chess, 1 Sudoku, 1 Connect 4",
        "target": 3, "game": "Multi",
        "reward_type": "points", "reward_value": 100, "reward_label": "+100 Points",
        "link": "https://t.me/Franklygames_bot/chess"
    },
]
...
WEEKLY_MISSIONS = [
    {
        "id": "w1",
        "description": "Play 7 matches of Chess this week",
        "target": 7, "game": "Chess",
        "reward_type": "points", "reward_value": 150, "reward_label": "+150 Points",
    },
    {
        "id": "w2",
        "description": "Complete 5 grids of Sudoku this week",
        "target": 5, "game": "Sudoku",
        "reward_type": "stars", "reward_value": 100, "reward_label": "+100 Stars",
    },
    {
        "id": "w3",
        "description": "Win 8 matches of Connect 4 this week",
        "target": 8, "game": "Connect 4",
        "reward_type": "free_spin", "reward_value": 10, "reward_label": "+10 Free Spins",
    },
    {
        "id": "w4",
        "description": "Complete 3 Chess, 3 Sudoku, 3 Connect 4",
        "target": 9, "game": "Multi",
        "reward_type": "points", "reward_value": 300, "reward_label": "+300 Points",
    },
]

# Wheel Segments (12 slices, static highlight)
WHEEL_SEGMENTS = [
...
def get_user(user_id: str) -> dict:
    ...
    if user_id not in users:
        users[user_id] = {
            ...
            "ad_watch_count": 0,
            "free_spins": 5,  # αρχικά δωρεάν spins
            "inventory": [],
            "equipped": {},
            "pet_skin": "🐱",
            "pet_name": "Whiskers",
    ...
    if u.get("last_daily_reset") != today:
        u["daily_missions"] = {
            m["id"]: {"progress": 0, "claimed": False} for m in DAILY_MISSIONS
        }
    ...
    if u.get("last_weekly_reset") != week_start:
        u["weekly_missions"] = {
            m["id"]: {"progress": 0, "claimed": False} for m in WEEKLY_MISSIONS
        }
...
async def update_mission_progress(request: Request):
    """Καλείται από τα Mini Apps όταν ο χρήστης ολοκληρώνει ένα παιχνίδι."""
    check_auth(request)
    ...
    for mlist, key in [(DAILY_MISSIONS, "daily_missions"), (WEEKLY_MISSIONS, "weekly_missions")]:
        for m in mlist:
            ...
            if m["game"] == game or m["game"] == "Multi":
                # Για Multi-game αποστολές, κάθε play μετράει
                if playtime > 0 or score > 0:
                    u[key][mid]["progress"] = min(
                        m["target"],
                        u[key][mid].get("progress", 0) + 1
                    )
...
async def claim_mission(request: Request):
    ...
    if not mdef:
        raise HTTPException(status_code=404, detail="Mission definition not found")

    if md.get("progress", 0) < mdef["target"]:
...
async def wheel_spin(request: Request):
    ...
    # Αν είναι zonk, απλά σώζουμε και επιστρέφουμε (δεν πιστώνεται τίποτα)
    # Τα άλλα τα χειρίζεται το frontend μέσω pop-up και μετά καλεί /add-points, /add-stars, /add-free-spins
    save_user(user_id, u)
